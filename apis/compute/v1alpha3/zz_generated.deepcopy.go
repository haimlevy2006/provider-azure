...
func (in *AKSClusterParameters) DeepCopyInto(out *AKSClusterParameters) {
	*out = *in
	...
	if in.AgentPoolProfiles != nil {
		...
		*out = make([]AgentPoolProfiles, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AgentPoolProfiles) DeepCopyInto(out *AgentPoolProfiles) {
	*out = *in
	if in.Name != nil {
	...
	if in.NodeVMSize != nil {
		in, out := &in.NodeVMSize, &out.NodeVMSize
		*out = new(string)
		**out = **in
	}
	if in.MaxPods != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AgentPoolProfiles.
func (in *AgentPoolProfiles) DeepCopy() *AgentPoolProfiles {
	if in == nil {
		return nil
	}
	out := new(AgentPoolProfiles)
	in.DeepCopyInto(out)
	return out
}
